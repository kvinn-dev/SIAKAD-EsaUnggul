  ...
  static seed(): void {
    ...
    const mockCourses: Course[] = [
      {
        ...
        lecturer_name: 'Dewi Setiowati, A.Md., S.Pd., M.Tr.Kom.',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        id: 'crs_2',
        course_code: 'CIE408',
        course_name: 'Arsitektur Berorientasi Layanan',
        lecturer_name: 'Hermansyah , S.Kom, M.Kom',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        ...
        lecturer_name: 'Prof. Dr. Vitri Tundjungsari , ST., M.Sc., M.M',
        credits: 4,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        ...
        lecturer_name: 'Azifa Habiba , S.Kom., M.Kom.',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        id: 'crs_5',
        course_code: 'CSF414',
        course_name: 'Analisis dan Perancangan Sistem Informasi',
        lecturer_name: 'Arief Ichwani , ST, MT',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        ...
        lecturer_name: 'Agus Herwanto , S.Kom, M.M',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        id: 'crs_7',
        course_code: 'CIE406',
        course_name: 'Keamanan Informasi',
        lecturer_name: 'Adi Widiantono , S.Kom, M.Kom',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
      },
      {
        id: 'crs_8',
        course_code: 'CIE405',
        course_name: 'Manajemen Proyek Perangkat Lunak',
        lecturer_name: 'Bambang Irawan , S.Kom, M.Kom, Ph.D',
        credits: 3,
        semester: 4,
        created_at: now,
        updated_at: now,
    ...
    const mockNotifications: Notification[] = [
      ...
      },
      {
        ...
        message: 'Dosen Hermansyah , S.Kom, M.Kom telah merilis nilai UTS untuk mata kuliah Arsitektur Berorientasi Layanan dengan nilai: 88 (A). Silakan cek di portal akademik untuk detail nilai.',
        type: 'nilai',
        is_read: false,
      ...
      },
      {
        ...
        message: 'Absensi Anda pada pertemuan ke-12 mata kuliah Pemrograman Web telah terverifikasi sebagai Hadir.',
        type: 'absensi',
        is_read: true,
